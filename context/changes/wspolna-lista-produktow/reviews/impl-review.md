...
- **Decision**: AWAITING OWNER — the owner is performing the check; Progress rows 1.7 and 2.9 stay unchecked until they report back. Not fixable from here: no browser.
